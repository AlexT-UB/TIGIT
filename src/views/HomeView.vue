              ...
              <v-row no-gutters>
                ...
                <v-col>
                  ...
                  <v-card-title>
                    ...
                    <v-spacer></v-spacer>
                    <div class="black--text text-body-2 font-italic"
                         v-text="item.date">
                    </div>
                  </v-card-title>
    ...
    return {
      ...
      items: [
        ...
        { title: 'Clarificación de un mensaje de la UB', username: 'YellowHoward', date: '4:57 5/6/2022',
          ...
          profile_pic: require("../assets/profile_Pics/erizo.png"),image: null, docs: null, hastags: "#UB"},
        { title: '¿Cómo o dónde consigo prácticas?', username: 'Miguel_UB', date: '4:57 5/6/2022',
          profile_pic: require("../assets/profile_Pics/escorpion.png"),
          image: null,
          text: 'Hola, ya estoy cerca de poder realizar prácticas para ingeniería informática y me preguntaba si sabían de alguna empresa buena donde pueda comenzar o cuál sería la mejor forma de encontrar.', docs: null, hastags: "#Practicas, #Informatica, #Trabajo "},
        { title: 'Estudiante de intercambio', username: 'EnglishStudentInBarcelona', date: '4:54 5/6/2022',
          text: '¡Buenas!, soy un estudiante de intercambio, he venido de Durham a estudiar psicología en la UB. Me preguntaba si alguien tendría la amabilidad de quedar conmigo un día en la cafetería para hacer amigos y crear un grupo, ¡yo invito!',
          profile_pic: require("../assets/profile_Pics/medusa.png"),image: require("../assets/post_Pics/durham.png"), docs: null},
        { title: '¿Cómo cambio el color del subtítulo en vuetify?', username: 'AlexUBInfo', date: '4:52 5/6/2022',
          text: 'Estoy desarrollando una web para un proyecto de clase pero al asignar el color a un subtítulo, este no cambia y sigue de color blanco. Me gustaría ponerlo de color naranja, ya que combina con el azul y además en color blanco no se ve, ya que los posts son de color blanco de fondo. \n ' +
              'Adjunto una captura del código.',
          profile_pic: require("../assets/profile_Pics/murcielago.png") ,image: require("../assets/post_Pics/Hashtags.png"), docs: null, hastags: "#UB, #Vue, #html, #JS, #Vuetify"}
      ]
    }
  },
};
