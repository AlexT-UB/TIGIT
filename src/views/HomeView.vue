    ...
    return {
      ...
      items: [
        ...
        { title: 'Comparto mis apuntes!', username: 'Ligotti22', date: '4:58 5/6/2022',
          ...
          profile_pic: require("../assets/profile_Pics/blowfish.png"), docs: "Mis_Apuntes_de_Estadistica.pdf",
          image: null, hastags: "#Apuntes, #UB, #Estadisticas, #Academia"},
        ...
        { title: '¿Cómo o dónde consigo prácticas?', username: 'Miguel_UB', date: '4:57 5/6/2022',
          ...
          image: null,
          text: 'Hola, ya estoy cerca de poder realizar prácticas para ingeniería informática y me preguntaba si ' +
              'sabían de alguna empresa buena donde pueda comenzar o cuál sería la mejor forma de encontrar.',
          docs: null, hastags: "#Practicas, #Informatica, #Trabajo "},
        { title: 'Estudiante de intercambio', username: 'EnglishStudentInBarcelona', date: '4:54 5/6/2022',
          text: '¡Buenas!, soy un estudiante de intercambio, he venido de Durham a estudiar psicología en la UB. Me ' +
          ...
          profile_pic: require("../assets/profile_Pics/medusa.png"),image: require("../assets/post_Pics/durham.png"),
          docs: null, hastags: "#Personal, #Grupo, #Barcelona, #Amigos"},
        { title: '¿Cómo cambio el color del subtítulo en vuetify?', username: 'AlexUBInfo', date: '4:52 5/6/2022',
          text: 'Estoy desarrollando una web para un proyecto de clase pero al asignar el color a un subtítulo, este ' +
          ...
          image: require("../assets/post_Pics/Hashtags.png"), docs: null, hastags: "#UB, #Vue, #html, #JS, #Vuetify"}
      ]
    }
  },
};
